...
![ice_rink](/assets/images/Milestone_1_Q_2(2).PNG){: width="80%"}
...
Additionally here is our html plot (https://github.com/Anshita1Saxena/milestone_project/blob/dev0.1/blogpost_milestone_1/assets/images/Milestone1_Q_6_1.html)

Here is a little summary of our builds done on Heroku: ![Heroku builds](blogpost_milestone_1/assets/images/heroku-apps-advancedvisuals-2022-10-23.png){: width="90%"}
