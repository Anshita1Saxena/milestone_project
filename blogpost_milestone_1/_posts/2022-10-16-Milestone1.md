...
- Fourthly, we have added the "rink side" for checking the position of the team who took the shot. This is required to transform the coordinates to the left side of the rink (left offense).
